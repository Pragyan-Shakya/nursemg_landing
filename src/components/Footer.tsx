...
export default function Footer() {
					...
					<div className='bg-purple-primary pt-12 sm:pt-16 px-6 sm:px-12 rounded-t-4xl'>
						...
						<div className='hidden sm:grid sm:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-12 items-start'>
							...
							<div>
								...
								<div className='flex gap-4'>
									<Link href="https://www.facebook.com/nclex100" target="_blank" rel="noopener noreferrer" className='text-purple-200 hover:text-white transition-colors'>
									...
									<Link
										href='https://x.com/i/flow/login?redirect_after_login=%2Fnclex100' target='_blank'
										className='text-purple-200 hover:text-white transition-colors'>
  ...
  <path d="M12.6.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867-5.07-4.425 5.07H.316l5.733-6.57L0 .75h5.063l3.495 4.633L12.601.75Zm-.86 13.028h1.36L4.323 2.145H2.865z"/>
									...
									<Link
										href='https://www.instagram.com/nclex100/' target='_blank'
										className='text-purple-200 hover:text-white transition-colors'>
